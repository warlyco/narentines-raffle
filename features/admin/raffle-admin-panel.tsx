  ...
  const handleAddRaffle = useCallback(
    async (event: any) => {
      ...
      try {
        ...
        showToast({ primaryMessage: "Raffle added!" });
      } catch (error) {
        console.error(error);
      } finally {
        setIsLoading(false);
  ...
  return (
    <>
      ...
      <form className="space-y-2">
        ...
        <label htmlFor="price-in-goods" className="flex space-x-4 items-center">
        ...
        <label htmlFor="price-in-dust" className="flex space-x-4 items-center">
        ...
        <label htmlFor="price-in-forge" className="flex space-x-4 items-center">
        ...
        <label htmlFor="price-in-gear" className="flex space-x-4 items-center">
        ...
        <label htmlFor="total-tickets" className="flex space-x-4 items-center">
        ...
        <label htmlFor="total-winners" className="flex space-x-4 items-center">
